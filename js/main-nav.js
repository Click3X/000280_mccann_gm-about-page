    ...
    function checkNav() {
        ...
        for (var i=0; i < aArray.length; i++) {
            var theID = aArray[i],
                ...
                // console.log('This is windowPos: ' + windowPos);
        ...
        //     if (!$("nav li:last-child a").hasClass("c3xgm-about-nav-bullet-active")) {
        //         var navActiveCurrent = $(".c3xgm-about-nav-bullet-active").attr("href");
        //         $("a[href='" + navActiveCurrent + "']").removeClass("c3xgm-about-nav-bullet-active");
        //         $("nav li:last-child a").addClass("c3xgm-about-nav-bullet-active");
        //     }
        // } 
    }
