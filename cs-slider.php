    ...
    <body>
        ...
        <?php include('php/main-navigation.php'); ?>
         ...
         <!-- MAIN PAGE CONTAINER -->
            ...
            <!-- <div id="c3xgm-about-module-technology" class="main c3xgm-about-module-technology"> -->
                <?php
                    $techModBlocks = $pages[3]['sections'][2]['module']['blocks'];
                    printTechModule($techModBlocks);
                ?>
            <!-- </div> -->
