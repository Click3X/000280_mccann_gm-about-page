...
<div class="c3xgm-about-clearfix c3xgm-about-main-nav-container">
	...
	<?php
		...
		foreach ($pages as $key => $page) {
			...
			echo '<li><a href="#c3xgm-about-page-'.$href.'" class="'.$active_state.'"><span class="c3xgm-about-inner-bullet"></span></a><span class="c3xgm-about-nav-hover-title c3xgm-about-clearfix">'.$nav_title.'</span>';
				if( isset($page['sections']) ) {
					echo '<ul class="c3xgm-about-clearfix c3xgm-about-main-nav-sub">';
						foreach ($page['sections'] as $key => $section) {
							...
							if($key == 0) { $active_state = 'c3xgm-about-nav-bullet c3xgm-about-nav-bullet-active'; } else { $active_state = 'c3xgm-about-nav-bullet';}
						echo '<li><a href="#c3xgm-about-page-'.$href.'" class="'.$active_state.'"><span class="c3xgm-about-inner-bullet"></span></a><span class="c3xgm-about-nav-hover-title c3xgm-about-nav-hover-sub-title c3xgm-about-clearfix">'.$nav_sub_title.'</span>';
						}
					echo '</ul>';
				}
			echo '</li>';
